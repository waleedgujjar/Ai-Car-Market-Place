...
import {carMakes, featuredCars} from "../lib/data.js";
import CarCard from "../components/car-card.jsx";
import { Button } from "../components/ui/button";
import Link from "next/link";
import { Calendar, Car, ChevronRight, Shield } from "lucide-react";
import { bodyTypes, faqItems } from "../lib/data.js";
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-6 gap-4">
             {carMakes.map((make) => {
              return (
                ...
                className="bg-white rounded-lg shadow p-4 text-center hover:shadow-md transition cursor-pinter"
                >
